      ...
      groups: [
        {
          title: '地图组件',
          items: [
            { title: '地图基础', link: '/pages/componentDemo/map/mapDemo/mapDemo' },
            ...
            { title: '地图综合', link: '/pages/componentDemo/mapsdk/mapComprehensive/mapComprehensive' }
          ]
        },
        {
          title: '地图服务',
          items: [
            ...
            { title: '地址逆向解析1', link: '/pages/componentDemo/mapsdk/mapSearchInput/mapSearchInput' },
            { title: '地址逆向解析2', link: '/pages/componentDemo/mapsdk/reverseAddressResolution/reverseAddressResolution' }
          ]
        }
      ]
    }
