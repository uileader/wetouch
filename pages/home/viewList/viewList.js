      ...
      groups: [
        {
          title: '基础容器 view',
          items: [
            { title: '基础', link: '/pages/componentDemo/view/view' },
        ...
        },
        {
          ...
          items: [
            ...
            { title: '栅格布局综合', link: '/pages/componentDemo/row/rowImg' },
        ...
        },
        {
          ...
          items: [
            { title: '纵向滚动：基础', link: '/pages/componentDemo/scrollView/scrollView' },
            ...
            { title: '横向滚动：基础', link: '/pages/componentDemo/scrollView/scrollView4' },
        ...
        },
        {
          ...
          items: [
            { title: '基础', link: '/pages/componentDemo/swipeOut/swipeOut' }
          ]
        },
        {
          title: '位置固定容器 fixed-view',
          items: [
              { title: '基础', link: '/pages/componentDemo/fixedView/fixedView' },
        ...
        },
        {
          title: '吸顶容器 sticky',
          items: [
              { title: '基础', link: '/pages/componentDemo/sticky/sticky' },
              { title: '多个吸顶容器共用', link: '/pages/componentDemo/sticky/sticky2' },
              { title: '应用案例', link: '/pages/componentDemo/sticky/sticky3' },
              { title: 'tabs与sticky结合', link: '/pages/componentDemo/sticky/sticky5' },
