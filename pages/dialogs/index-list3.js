export default {
  ...
  methods: {
    ...
    singleselect (e) {
      ...
      this.country = msg
      ui.hideDialog({
        country: this.country, index: 3
      })
    },
    multiselect (selected) {
      this.msg = Object.keys(selected).reduce((a, b) => {
        if (a) {
          return a + selected[b].join(',')
        }
        return selected[b].join(',') + ','
      }, '')
    },
    hideWindow (e) {
      ui.hideDialog()
